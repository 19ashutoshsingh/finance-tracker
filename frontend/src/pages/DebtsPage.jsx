...
const DebtsPage = () => {
    ...
    // Filter the debts list based on the search term
    ...
    // Separate the filtered list into money lent and borrowed
    ...
    // Reusable card component for displaying a single debt record
    const DebtCard = ({ debt }) => (
    ...
    return (
        <>
            ...
            {/* Modal for adding a new debt record */}
